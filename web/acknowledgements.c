/*----------------------------------------------------------------------------*/
/* Xymon acknowledgements log viewer                                              */
/*                                                                            */
...
int main(int argc, char *argv[])
{
	...
	redirect_cgilog("acknowledgements");
	...
	if (cgidata == NULL) {
		...
		showform(stdout, "acknowledgements", "acknowledgements_form", COL_BLUE, getcurrenttime(NULL), NULL, NULL);
		return 0;
	}
